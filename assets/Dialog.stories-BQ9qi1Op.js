...
\`\`\`,
  ...
  renderDialog();
  return wrapper;
}`,...(k=(L=g.parameters)==null?void 0:L.docs)==null?void 0:k.source}}};var B,N,R;m.parameters={...m.parameters,docs:{...(B=m.parameters)==null?void 0:B.docs,source:{originalSource:`() => {
  const wrapper = createStoryWrapper();
  const renderDialog = () => {
    const dialog = createDialog({
      fullscreen: true,
  ...
  renderDialog();
  return wrapper;
}`,...(R=(N=m.parameters)==null?void 0:N.docs)==null?void 0:R.source}}};const A=["LiveExample","Showcase","AlertDialog","InfoDialog","FullscreenDialog"];export{u as AlertDialog,m as FullscreenDialog,g as InfoDialog,i as LiveExample,p as Showcase,A as __namedExportsOrder,H as default};
