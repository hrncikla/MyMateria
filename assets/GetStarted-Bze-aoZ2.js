import{j as s,M as i}from"./index-atSoaKhH.js";import{useMDXComponents as o}from"./index-BKthzpKn.js";import"./iframe-CnA8-RDm.js";import"./index-CfOrKyLd.js";import"./index-DrFu-skq.js";function r(e){const n={br:"br",code:"code",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",p:"p",pre:"pre",strong:"strong",ul:"ul",...o(),...e.components};return s.jsxs(s.Fragment,{children:[s.jsx(i,{title:"Get Started"}),`
...
`,s.jsx(n.pre,{children:s.jsx(n.code,{className:"language-html",children:`<link rel="stylesheet" href="/build/css/materia.min.css" />
`})}),`
...
├── ...
`})}),`
`,s.jsx(n.p,{children:"Then you can use src/index.html."}),`
`,s.jsxs(n.p,{children:[s.jsx(n.strong,{children:"Option 2: Just SCSS Folder"}),s.jsx(n.br,{}),`
`,"If you only need the core styles, you can copy just the ",s.jsx(n.code,{children:"scss/"})," directory and delete other folders:"]}),`
`,s.jsx(n.pre,{children:s.jsx(n.code,{className:"language-bash",children:`CSS-Materia/ \r
├── build/           \r
├── public/                    \r
├── src/\r
